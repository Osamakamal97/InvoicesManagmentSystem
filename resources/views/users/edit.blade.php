...
@section('title',__('frontend.edit_user'))
@section('css')
...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto"><a href="{{ route('users.index') }}">{{ __('frontend.users') }}</a></h4><span
                class="text-muted mt-1 tx-13 mr-2 mb-0">/
                {{ __('frontend.edit_user') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0 ">
            <div class="card-header">
                <h4 class="card-title mb-1">{{ __('frontend.edit_user') }}</h4>
            </div>
                ...
                <form action="{{ route('users.update' ,$user->id) }}" method="POST" data-parsley-validate=""
                    ...
                    <div class="row row-sm">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" name="name" autofocus placeholder="{{ __('frontend.name') }}"
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <label class="rdiobox" for="enable"><input name="status" type="radio" value="1"
                                        ...
                                        <span>{{ __('frontend.enable') }}</span></label>
                                </div>
