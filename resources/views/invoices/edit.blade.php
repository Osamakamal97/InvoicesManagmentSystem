...
@section('title',__('frontend.edit_invoice'))
@section('css')
    ...
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0 ">
            <div class="card-header">
                <h4 class="card-title mb-1">{{ __('frontend.edit_invoice') }}</h4>
            </div>
                    ...
                    <div class="row row-sm">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" name="invoice_number"
                                ...
                                placeholder="{{ __('frontend.invoice_number') }}"
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" name="collection_amount"
                                ...
                                id="invoiceCollectionAmount" placeholder="{{ __('frontend.collection_amount') }}"
                                onchange="myFunction()"
                    ...
                    <div class="row row-sm">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" name="commission_amount"
                                ...
                                id="commission_amount" placeholder="{{ __('frontend.commission_amount') }}"
                                onchange="myFunction()"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" name="discount"
                                ...
                                placeholder="{{ __('frontend.discount') }}" onchange="myFunction()"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <select class="form-control SlectBox" name="rate_vat" id="rate_VAT" onchange="myFunction()"
                                ...
                                <option label="{{ __('frontend.choose_rate_VAT') }}" value="0">
            ...
            if (sectionId != null) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('select[name="product_id"]')[0].sumo.add('0', "{{ __('frontend.choose_product') }}");
