...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('invoices/{invoice}/editStatus', [InvoiceController::class, 'editStatus'])->name('invoices.edit_status');
    Route::put('invoices/{invoice}/updateStatus', [InvoiceController::class, 'updateStatus'])->name('invoices.update_status');
    ...
    // Notifications
    Route::get('notification/read-all', [NotificationController::class, 'readAllNotifications'])->name('notifications.read_all');
